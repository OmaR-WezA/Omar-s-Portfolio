          ...
          <div className="flex items-center justify-between">
            ...
            <div className="hidden lg:flex items-center space-x-3">
              <Button
                ...
                size="sm"
                onClick={downloadCV}
                className="flex items-center gap-2 hover:bg-primary hover:text-primary-foreground transition-all duration-200 bg-transparent"
              >
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            ...
            className="fixed top-[73px] left-0 right-0 z-30 lg:hidden bg-background/95 backdrop-blur-xl border-b border-border/50"
          >
